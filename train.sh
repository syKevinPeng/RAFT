...
# Vulcan Server use:
python3 -u train.py --name exp6_l2_r2 \
	--output_dir /vulcanscratch/peng2000/train_from_scratch_raft/l2_r2 --dataset_dir /vulcanscratch/peng2000/ChairsSDHom \
	--stage chairSD --validation chairSD --gpus 0 --num_steps 300000\
	--batch_size 8 --lr 0.005  --image_size 360 496  --wdecay 0.0001 --mixed_precision